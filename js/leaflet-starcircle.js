...
L.Canvas.include({
  _updateStarCircle: function (layer) {
    ...
    if (layer._star > 2) {
      var verts = createStar(layer._star, layer._point.x, layer._point.y, layer._radius,layer._rotation),
        j;
...
L.SVG.include({
  _updateStarCircle: function (layer) {
    ...
    if (layer._star > 2) {
      this._setPath(layer, L.SVG.pointsToPath([createStar(layer._star, layer._point.x, layer._point.y, r,layer._rotation)], true));
    } else {
